...
import {FaUser,FaEnvelope,FaPhone,FaMapMarkerAlt, FaIdCard, FaCheckCircle,FaShieldAlt} from "react-icons/fa";
  ...
  useEffect(() => {
    api.get("/api/admins/profile")
      ...
      .catch((err) => {
        ...
        setError("Impossible de charger votre profil administrateur.");
      })
      .finally(() => {
        setLoading(false);
      });
        ...
        <div className="profile-container">
          <div className="page-header d-flex justify-content-between align-items-center mb-4">
            <div>
              ...
              <p className="text-muted small m-0">Consultez vos informations administrateur.</p>
            </div>
            ...
            <div className="profile-card">
              <div className="profile-header">
                ...
                <div>
                  ...
                  <span className="profile-role-badge admin">Administrateur</span>
                </div>
              </div>
                ...
                <div className="row g-3">
                  ...
                  {profile.cin && (
                    <div className="col-md-6">
                      ...
                      <div className="profile-value">{profile.cin}</div>
                    </div>
                  )}

                  <div className="col-md-6">
                    <label className="profile-label">
                      <FaShieldAlt className="me-1 text-muted" /> Rôle
                    </label>
