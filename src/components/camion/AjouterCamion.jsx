...
function AjouterCamion() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      setTimeout(() => {
        navigate(isAdmin ? "/admin/camions" : "/transporteur/camions");
      }, 2000);
    } catch (error) {
              ...
              <div className="form-grid">
                ...
                <div className="form-group">
                  ...
                  <input
                    type="text"
                    className={`form-control-custom ${
                      errors.immatriculation ? "is-error" : ""
                    }`}
                ...
                {isAdmin && (
                  <div className="form-group">
                    ...
                    <select
                      className={`form-control-custom ${
                        errors.transporteurId ? "is-error" : ""
                      }`}
                      {...register("transporteurId")}
                    >
                      <option value="">
